...
public class PatientRecordControllerTest {
    ...
    public void getAllRecords_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(jsonPath("$[1].name", Matchers.is("David Landup")));
        ;
    }
    ...
    public void updatePatientRecord_nullId() throws Exception {
        ...
        mockMvc.perform(mockRequest)
                ...
                .andExpect(result ->
                        assertEquals("PatientRecord or ID must not be null!", result.getResponse().getErrorMessage()));
    }
    ...
    public void updatePatientRecord_recordNotFound() throws Exception {
        ...
        mockMvc.perform(mockRequest)
                .andExpect(status().isBadRequest())
                .andExpect(result ->
                        assertEquals("Patient with ID 5 does not exist.", result.getResponse().getErrorMessage()));
    }
